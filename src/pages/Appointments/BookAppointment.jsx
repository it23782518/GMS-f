...
const BookAppointment = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.traineeId) return "Please enter trainee ID"
    ...
    <div className="bg-gray-50 py-6 sm:py-8 md:py-12">
      <div className="container mx-auto px-4 sm:px-6 max-w-full">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          ...
          <div className="p-5 sm:p-6 md:p-8 max-w-4xl mx-auto">
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="traineeId" className="block text-sm font-medium text-gray-700 mb-1">
                    Member ID
                  </label>
                  <input
                    type="text"
